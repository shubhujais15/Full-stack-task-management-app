const Restaurantcards = (props) => {
    ...
    return(
      <div className="md:mx-8 mx-4 my-6 p-2 h-[280px] md:h-[305px] w-[172px] md:w-[220px] rounded-xl md:rounded-lg bg-slate-50 transition-transform duration-500 transform scale-100 hover:scale-105">
        <img alt="" className="h-[100px] w-[132px] md:h-32 md:w-48 mx-[12px] md:mx-1.5 mt-2 rounded-lg" src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/"+cloudinaryImageId}></img>
